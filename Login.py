...
def verifica_senha():
    ...
    if nome == 'admin' and senha == 'admin':
        ...
        # deletar itens no frame baixo e frame cima
...
# funcao após verificacao ------------------------------


def nova_janela():
    l_nome = Label(frame_cima, text='Usuário : ' +
...
l_nome = Label(frame_baixo, text='Name *', anchor=NW,
...
e_pass = Entry(frame_baixo, width=25, justify='left', show='*',
               font=("", 15), highlightthickness=1, relief='solid')
e_pass.place(x=14, y=130)

b_confirmar = Button(frame_baixo, command=verifica_senha, text='Entrar', width=39, height=2, font=(
